        ...
        <div className="bg-primary/10 border border-primary/30 flex flex-col md:flex-row md:items-center md:justify-between w-auto sm:w-[823px] my-6 px-2 py-3 mr-4 rounded-xl">
            ...
            <div className="flex flex-col h-full justify-evenly">
                <div className="flex gap-3 items-center pt-2">
                    ...
                    {!booking.isPaid && <button className="bg-primary hover:bg-primary-dull duration-300 transition px-4 py-1.5 mt-2 mb-3 text-sm rounded-lg font-medium cursor-pointer">Pay Now</button>}
                </div>
